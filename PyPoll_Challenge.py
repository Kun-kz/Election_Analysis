...
# Modification: descending county_votes and candidate_votes     
#county_votes = dict(sorted(county_votes.items(), key = lambda item: item[1], reverse = True))
#candidate_votes = dict(sorted(candidate_votes.items(), key = lambda item:item[1], reverse = True))
...
with open(file_to_save, "w") as txt_file:
    ...
    largest_turnout_county_summary=(
        ...
        f"-------------------------\n")
    print(largest_turnout_county_summary, end="")
